...
import { FaFileAlt, FaSearch, FaEye, FaMapMarkerAlt, FaUserTie } from 'react-icons/fa';
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y">
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={6} className="p-8 text-center text-gray-500">
                                        No reports found for your projects.
                                    </td>
                                </tr>
                            ) : (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="text-gray-600">{selectedReport.weatherConditions || 'N/A'}</p>
                            </div>
                            <div>
                                <h4 className="font-medium text-gray-700 mb-2">Workers Present</h4>
                                <p className="text-gray-600">{selectedReport.workersPresent || 0}</p>
                            </div>
                        </div>
